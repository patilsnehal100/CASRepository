...
public class SalesforceTemplateListTest extends BaseClass{
	@Test(priority =1)
	...
	@Test(priority=3)
	public void Salesforce_List() throws InterruptedException
	{
		HomePage homepage=PageFactory.initElements(driver,HomePage.class);
		homepage.clickonNewList();	
		
		SalesforcePage salesforcePage=PageFactory.initElements(driver,SalesforcePage.class);
		salesforcePage.createSalesforceTemplateList("SalesforceList3");
