...
public class SalesloftTeamcadenceListTest extends BaseClass{
	...
	public void salesloft_MycadenceList() throws InterruptedException
	{
		...
		salesloftPage.createTeamCadenceList(TestData.salesloftTeamcadence_listname);
	...
	public void callDisposition() throws InterruptedException
	{
		...
		dispositionpage.disposeCallSalesloftTeam();
